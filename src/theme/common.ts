...
export const useSpacing = (theme: any ) => ({
  mainWrap: {
    position: 'relative',
    width: '100%',
    overflow: 'hidden',
...
export const usePopup = (theme: any ) => ({
  appBar: {
    position: 'relative',
  },
  title: {
...
export const useText = (theme: any ) => ({
  title: {
...
export const useHidden = (theme: any ) => ({
  lgDown: {
...
export const useFlipRtl = (theme: any ) => ({
